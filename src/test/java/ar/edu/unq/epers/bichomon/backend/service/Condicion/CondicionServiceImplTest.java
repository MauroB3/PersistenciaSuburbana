...
public class CondicionServiceImplTest {
    ...
    public void setUp(){
        ...
        when(entrenador.getNivel()).thenReturn(7);
    ...
    public void crearCondicionYGetCondicion() {
        ...
        assertTrue(service.getCondicion(1).cumpleConLaCondicion(bicho));
        assertTrue(service.getCondicion(2).cumpleConLaCondicion(bicho));
        assertTrue(service.getCondicion(3).cumpleConLaCondicion(bicho));
        assertTrue(service.getCondicion(4).cumpleConLaCondicion(bicho));
        assertTrue(service.getCondicion(5).cumpleConLaCondicion(bicho));
    }
